...
6. 게임 시작을 누릅니다. 문제 순서는 자동으로 랜덤하게 섞입니다.
7. 문제마다 정답 공개, 다음 문제를 진행합니다.
8. 마지막에 최종 랭킹을 확인합니다.
...
6. 제출된 칭찬 카드 목록을 확인하고, 부적절한 카드는 삭제합니다.
7. 게임 시작을 누릅니다. 칭찬 카드 순서는 자동으로 랜덤하게 섞입니다.
8. 첫 단서가 공개되면 학생들이 칭찬 대상을 추리합니다.
9. 다음 단서 공개를 눌러 단서를 하나씩 늘립니다.
10. 적절한 시점에 칭찬 대상 공개를 누릅니다.
11. 작성자 추리 시작을 누릅니다.
12. 작성자 공개를 누르면 카드 결과와 누적 랭킹을 확인할 수 있습니다.
13. 다음 칭찬으로 이동합니다.
14. 모든 카드가 끝나면 최종 랭킹을 봅니다.
